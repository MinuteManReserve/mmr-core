...
#if defined(NDEBUG)
# error "MinuteManReserve cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "MinuteManReserve Signed Message:\n";
...
{
    RenameThread("minutemanreserve-loadblk");
